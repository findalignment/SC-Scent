...
export default function SearchBar() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-80 bg-[#1a2f4a] border border-amber-900/30 shadow-2xl p-4 z-50">
          <form onSubmit={handleSearch}>
            <div className="relative">
              ...
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-1 bg-amber-600 hover:bg-amber-700 text-white text-sm font-medium transition-colors"
              >
                Search
              </button>
            </div>
